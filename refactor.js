...
// The "x" is first overridden by the variable "y" in the first function, but then there is a
// 1 delay on when "y" is supposed to be logged so it changes the variable to "z" and logs that first.
// So the answer would be [C] Z then Y
// -----------------------------------------------
